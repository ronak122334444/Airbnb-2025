...
public class sendemail 
{
    ...
    String port = "587";
    String mailFrom = "vmmcab7@gmail.com";
    String password = "etyp lqba monr ayat";
...
//            msg.setText(message);
    ...
    public static void main(String[] args) 
    {
      String otp =  (int) (1000+(9999-1000)*Math.random())+"";
            sendemail obj = new sendemail("arshkirat2003@gmail.com","Password Recovery","Your Otp is: "+otp);
    }
}